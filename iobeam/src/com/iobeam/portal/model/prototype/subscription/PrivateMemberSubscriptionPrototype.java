...
public class PrivateMemberSubscriptionPrototype extends SubscriptionPrototype {


	PrivateMemberSubscriptionPrototype(
			String description,
			boolean isAvailable,
		...
		super(SubscriptionType.PRIVATE_MEMBER,
	...
	PrivateMemberSubscriptionPrototype(SubscriptionPrototypePK pk,

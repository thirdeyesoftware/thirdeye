...
public class VenueOperatorSubscription extends Subscription {

	private VenuePK mEffectiveVenuePK;


	VenueOperatorSubscription(VenueOperatorSubscriptionPrototype proto,
			Date startDate,
			Date expirationDate,
		...
		super(SubscriptionType.VENUE_OPERATOR, proto.getPK(),
	...
	VenueOperatorSubscription(SubscriptionPK subscriptionPK,
			SecureID secureID,
			AccountPK accountPK,
	...
	*/
	...
	public String toString() {
		...
		sb.insert(0, "VenueOperatorSubscription(");

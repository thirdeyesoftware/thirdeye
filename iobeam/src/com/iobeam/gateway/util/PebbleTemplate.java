...
public class PebbleTemplate implements ConfigurationTemplate {
	...
	private static final String IP_PATH = "/ro/var/dnscache/env";
	...
	private void apply(Properties p, String templ,
		...
		BufferedReader reader = new BufferedReader(
				new InputStreamReader(
					PebbleTemplate.class.getResourceAsStream(templ)));
